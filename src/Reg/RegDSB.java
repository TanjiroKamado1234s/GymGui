...
public class RegDSB extends javax.swing.JFrame {
    ...
    public RegDSB() {
        ...
        try (Connection cn = new DBConnector().getConnection()) {
            ...
            PreparedStatement checkerStmt = cn.prepareStatement("SELECT COUNT(*) FROM tbl_user WHERE email = ? OR user = ? OR contact = ?");
            ...
            PreparedStatement insertStmt = cn.prepareStatement("INSERT INTO tbl_user (email,contact,user,pass,status) VALUES (?,?,?,?,'Active')");
