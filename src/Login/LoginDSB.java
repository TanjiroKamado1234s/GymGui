...
public class LoginDSB extends javax.swing.JFrame {
    ...
    public LoginDSB() {
       ...
       public static boolean loginAccount(String username, String password) {
        try (Connection cn = new DBConnector().getConnection()) {
            ...
            PreparedStatement checkStmt = cn.prepareStatement("SELECT COUNT(*) FROM tbl_user WHERE user = ? AND pass = ? AND status = 'Active'");
      ...
      public static void showTable(DefaultTableModel table) {
        ...
        try {
            ...
            ResultSet rs = new DBConnector().getData("SELECT * FROM tbl_user");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("GYM MEMBERSHIP");
